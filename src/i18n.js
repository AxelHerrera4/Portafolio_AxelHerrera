const translations = {
  es: {
    ...
    summary: 'Desarrollo web y optimización de procesos. Proactivo, adaptable y orientado a resultados.',
    ...
    tools: {
      ...
      backend: [
        ...
        {name: '.NET', icon: 'fas fa-cubes'}
      ],
      office: [
  {name: 'Word', icon: 'fas fa-file-word'},
  {name: 'Excel', icon: 'fas fa-file-excel'},
  {name: 'PowerPoint', icon: 'fas fa-file-powerpoint'},
  {name: 'Power BI', icon: 'fas fa-chart-line'}
      ],
      toolsOS: [
        {name: 'Windows 11', icon: 'fab fa-windows'},
        {name: 'VS Code', icon: 'fas fa-code'},
        {name: 'Visual Studio', icon: 'fas fa-desktop'},
        {name: 'Kali Linux', icon: 'fas fa-terminal'}
      ]
    },
  ...
  en: {
    ...
    summary: 'Web developer and process optimization. Proactive, adaptable, results-oriented.',
